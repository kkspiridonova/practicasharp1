...
SELECT ID_Director, FirstName, LastName, Country_ID FROM DIRECTOR WHERE (ID_Director = @ID_Director)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[DIRECTOR] WHERE (([ID_Director] = @Original_ID_Director))";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[DIRECTOR] ([FirstName], [LastName], [Country_ID]) VALUES (@Fir" +
                "stName, @LastName, @Country_ID)";
            ...
            this._commandCollection[3].CommandText = "UPDATE [dbo].[DIRECTOR] SET [FirstName] = @FirstName, [LastName] = @LastName, [Co" +
                "untry_ID] = @Country_ID WHERE (([ID_Director] = @Original_ID_Director));";
        ...
        public virtual int InsertQuery(string FirstName, string LastName, int Country_ID) {
            ...
            command.Parameters[2].Value = ((int)(Country_ID));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
        ...
        public virtual int UpdateQuery(string FirstName, string LastName, int Country_ID, int Original_ID_Director) {
